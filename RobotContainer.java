...
import frc.robot.commands.DriveForwardTimedCommands;
import frc.robot.commands.DriveTrainCommands;
import frc.robot.commands.ShooterCommand;
import frc.robot.commands.WashingMachineCommands;
...
public class RobotContainer {
  ...
  private final CommandBase m_autonomousCommand = new DriveForwardTimedCommands(m_drivetrain);
  ...
  private void configureButtonBindings() {
    ...
    washbutton.whileHeld(new WashingMachineCommands(m_washingMachine));
    ...
    shooterButton.whileHeld(new ShooterCommand(m_shooter));
    ...
    final JoystickButton elevatorButton = new JoystickButton(leftstick,1);
    collectorButton.whileHeld(new CollectorCommands(m_collector));
    ...
    if(leftstick.getRawButton(2)==true){
      CollectorCommands.set(1.0);} 
      
else{
      CollectorCommands.set(0);
