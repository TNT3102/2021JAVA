...
import frc.robot.commands.WashingMachine;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_drivetrain.setDefaultCommand(new DriveTrain(leftstick, rightstick, m_drivetrain));
...
//}
    ...
    washbutton.whileHeld(new WashingMachine(m_washingMachine));
    ...
    shooterButton.whileHeld(new Shooter(m_shooter));

    //if(leftstick.getRawButton(1)==true){
    //  Collector.set(-1.0);} 
    final JoystickButton collectorButton = new JoystickButton(leftstick,1);
    collectorButton.whileHeld(new Collector(m_collector));
